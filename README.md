...
- 文件关联：安装后双击 .md / .markdown / .txt 直接用 XMD 打开；Windows 右键菜单提供「使用 XMD 打开」
...
安装应用后，双击 `.md`、`.markdown` 或 `.txt` 文件即可直接用 XMD 打开；Windows 资源管理器中还可以通过右键菜单选择“使用 XMD 打开”。若应用已在运行，新打开的文件会进入现有窗口的新标签页。
